...
def get_command_line_parser():
    ...
    parser.add_argument('-nystrom_keep_dim', type=int, default=64, help="Nyström近似保留的维度")
    parser.add_argument('-nystrom_sample_ratio', type=float, default=0.1, help="Nyström近似的采样比例")
